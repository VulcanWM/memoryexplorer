...
void da_display(leaderboard *ptr, const int size) {
...
leaderboard *da_add_data(leaderboard *ptr, int *size, const char *username, const int score) {
...
int da_search_data(const leaderboard *ptr, const int size, const char *username) {
...
void da_amend_data(leaderboard *ptr, const int size, const char *username, int score) {
